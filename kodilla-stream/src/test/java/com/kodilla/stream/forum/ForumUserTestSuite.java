...
public class ForumUserTestSuite {
    ...
    public void testGetLocationsOfFriends() {
        ...
        //   user7:  "Washington"
        //   user10: "Miami"
        Assert.assertEquals(2, user3.getLocationsOfFriends().size());
        //Assert.assertTrue(user3.getLocationsOfFriends().contains("Key West"));
        Assert.assertTrue(user3.getLocationsOfFriends().contains("Washington"));
        Assert.assertTrue(user3.getLocationsOfFriends().contains("Miami"));
        Assert.assertFalse(user3.getLocationsOfFriends().contains("Orlando"));
    }
